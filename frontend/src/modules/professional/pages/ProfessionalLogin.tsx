...
const ProfessionalLogin: React.FC = () => {
  ...
  const { login, isLoading, error, clearError, isAuthenticated } = useProfessionalAuthStore();
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                type="email"
                required
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 focus:z-10 sm:text-sm"
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link to="/professional/signup" className="font-medium text-teal-600 hover:text-teal-500">
